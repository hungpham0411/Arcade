...
class Tictactoe_Difficulty_Screen(State):
    ...
    def render(self):
        ...
        self.game.screen.blit(pygame.transform.scale(self.tictactoe_difficulty_screen_background,(self.game.screen_width, self.game.screen_height)), (0,0))
    ...
    def load_assets(self):
        self.tictactoe_difficulty_screen_background = pygame.image.load(os.path.join('Assets', 'cyberpunk_background.jpg'))
