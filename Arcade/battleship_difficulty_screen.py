...
class Battleship_Difficulty_Screen(State):
    ...
    def render(self):
        ...
        self.game.screen.blit(pygame.transform.scale(self.battleship_difficulty_screen_background,(self.game.screen_width, self.game.screen_height)), (0,0)) 
    ...
    def load_assets(self):
        self.battleship_difficulty_screen_background = pygame.image.load(os.path.join('Assets', 'retro_background3.jpg'))
